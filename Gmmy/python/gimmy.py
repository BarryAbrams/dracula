...
scenes = [
    ...
    },
    {
        ...
        "light_animation":"hallway_ambient"
    },
    {
        "name":"parlor_off",
        "requirements":[],
        "replaces":[],
        "light_animation":"parlor_off"
    },
    {
        "name":"parlor_on",
        "requirements": [
        ...
        "light_animation":"parlor_ambient"
    },
    {
        "name":"bedroom_off",
        "requirements":[],
        "replaces":[],
        "light_animation":"bedroom_off"
    },
    {
        "name":"bedroom_on",
        "requirements": [
        ...
        "music":"242_Spiders_Den.mp3",
        "light_animation":"bedroom_ambient"
    },
    {
        "name":"illuminate",
        "requirements": [
...
class Timer(object):
    ...
    def start_timer(self):
        ...
        if not self.is_running:
            ...
            # self.background_sound.play_background('69_Forest_Night.mp3', fade_time=3000)
...
class SceneManager(object):
    ...
    def update_scenes(self):
        ...
        for active_scene in active_scenes:
            scene_names.append(active_scene['name'])
...
if __name__ == "__main__":
    ...
    disp = Display(timer)
    timer.display = disp
    # sound.play_background('148_Barovian_Castle.mp3', fade_time=3000)